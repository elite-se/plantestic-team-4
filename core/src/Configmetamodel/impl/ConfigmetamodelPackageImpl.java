...
public class ConfigmetamodelPackageImpl extends EPackageImpl implements ConfigmetamodelPackage {
	 ...
	 */
	@Override
	public EAttribute getConfigList_Name() {
		return (EAttribute)configListEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(configListEClass, CONFIG_LIST__NAME);
