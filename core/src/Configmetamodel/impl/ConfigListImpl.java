 ...
 *   <li>{@link Configmetamodel.impl.ConfigListImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigListImpl extends MinimalEObjectImpl.Container implements ConfigListImpl {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigmetamodelPackage.CONFIG_LIST__NAME, oldName, name));
	}
